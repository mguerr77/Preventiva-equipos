...
.SYNOPSIS
    ...
    Requiere privilegios de Administrador de manera inequívoca.
#>
...
Write-Host "`n--- Orquestando el Liberador de Espacio en Disco nativo (Cleanmgr) ---" -ForegroundColor Cyan
